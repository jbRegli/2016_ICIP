...
\section{Classification results}
  ...
  \subsection{MNIST}
      ...
      \begin{tabular}{  |p{0.2cm}
        ...
        \hline
        \multirow{2}{0pt}{$2$}  & ($20$)  & $29.7\%$  & $\mathbf{32.0}\%$ & $28.9\%$  & $\mathbf{32.2}\%$  \\
        \cdashline{3-6}
                                & (Full)  & $\mathbf{30.1}\%$  & $26.1\%$ & $\mathbf{29.1}\%$  & $25.6\%$  \\
        \hline
        \multirow{2}{0pt}{$5$}  & ($20$)  & $45.0\%$  & $\mathbf{56.5\%}$ & $35.1\%$  & $\mathbf{46.5\%}$ \\
        \cdashline{3-6}
                                & (Full)  & $\mathbf{45.5\%}$ & $43.2\%$  & $\mathbf{35.5\%}$ & $33.2\%$  \\
        \hline
        \multirow{2}{0pt}{$10$} & ($20$)  & $51.3\%$  & $\mathbf{64.8\%}$  & $49.1\%$   & $\mathbf{57.7\%}$ \\
        \cdashline{3-6}
